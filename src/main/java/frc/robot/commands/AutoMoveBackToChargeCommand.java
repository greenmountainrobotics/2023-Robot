...
public class AutoMoveBackToChargeCommand extends Command {
    private final IMUSubsystem iMUSubsystem;
    private final TankDriveSubsystem tankDriveSubsystem;
    private double initialAngle;

    public AutoMoveBackToChargeCommand(IMUSubsystem iMUSubsystem, TankDriveSubsystem tankDriveSubsystem) {
